package com.ftn.sep_udd.config;

import com.ftn.sep_udd.security.TokenUtils;
import com.ftn.sep_udd.security.auth.RestAuthenticationEntryPoint;
import com.ftn.sep_udd.security.auth.TokenAuthenticationFilter;
import com.ftn.sep_udd.service.CustomUserDetailsService;
...
//        http.cors();
        http
                ...
                .authorizeRequests()
                .antMatchers("/api/works/submitWorkData").permitAll()
